 ...
 */
    ...
    export class Lexer extends CodeExplorer{
        ...
        constructor(code, path = ''){
            ...
            // On stocke le code du fichier dans un tableau pour pouvoir le récupérer plus tard en cas d'erreur
            // Sauf si le meme code est deja présent dans le tableau, auquel cas on récupère l'index
            this.uuid =
            this.output.uuid = 
            Storage.behavior === 'highlight' ? 0 :
